...
{
    public partial class Frm_QLDDTQ : Form
    {
        public Frm_QLDDTQ()
        {
            InitializeComponent();
        ...
        {
            DTO.DTO_Admin.DTO_QLDDTQ dd = new DTO.DTO_Admin.DTO_QLDDTQ(txtMaDD.Text, txtTenDD.Text, cbbDiaChi.Text.ToString());
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            DTO_QLDDTQ dd = new DTO_QLDDTQ(txtMaDD.Text, txtTenDD.Text, cbbDiaChi.Text.ToString());
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (xl.KT_KhoaNgoaiDD(txtMaDD.Text) == false)
            {
                MessageBox.Show("Địa điểm đang được sử dụng không thể sửa!");
                txtMaDD.Focus();
                return;
            }
